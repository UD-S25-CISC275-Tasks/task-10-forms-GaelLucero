...
export function makeAnswers(questions: Question[]): Answer[] {
    let newAnswer: Answer[] = questions.map((question: Question) => ({
...
export function publishAll(questions: Question[]): Question[] {
    let pubQuestion = questions.map((question: Question) => ({
        ...question,
        published: true,
    }));
    return pubQuestion;
...
export function sameType(questions: Question[]): boolean {
    let isSame = questions.reduce(
        (counter: number, question: Question) =>
...
export function renameQuestionById(
    ...
    let renameQuestion: Question[] = questions.map((question: Question) => ({
        ...question,
...
export function changeQuestionTypeById(
    ...
    let changedQuestion = questions.map((question: Question) => ({
        ...question,
        options:
            (
...
export function editOption(
    ...
    if (targetOptionIndex === -1) {
        ...
        optionQuestion = questions.map((question: Question) => ({
            ...question,
            options:
                targetId === question.id ?
...
export function duplicateQuestionInArray(
    ...
    let findQuestionIndex = questions.findIndex(
        (question: Question) => targetId === question.id,
    );
